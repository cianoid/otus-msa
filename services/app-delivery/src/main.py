...
from src.api import delivery_router, main_router
...
async def lifespan(app: FastAPI) -> AsyncGenerator[None]:
    crud = DeliveryCRUD(AsyncSessionLocal)
    app.dependency_overrides[get_delivery_crud] = crud
...
setup_tracing(service_name="delivery", app=app)
